...
working_dir="C:\\Users\\admin\\documents\\MRD\\standardResult\\standard_3rdtrial\\errorSuppression\\AAABAC\\UMIdb\\"
os.chdir(working_dir)

mutation_ref_dir="C:\\Users\\admin\\documents\\MRD\\standardResult\\standard_3rdtrial\\mutation\\\AC\\"
writer = pd.ExcelWriter('AC_UMI_polished_FREQ_UMIdb.xlsx', engine='xlsxwriter')

# Read in rmbg.txt files
fileNames=[]
for file in glob.glob("*-AC*UMI*.txt"):
